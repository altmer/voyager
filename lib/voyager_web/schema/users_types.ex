defmodule VoyagerWeb.Schema.UsersTypes do
  ...
  object :users_queries do
    field :user,
      type: :user,
      description: "Get a user of the app (for user profile page f.ex.)" do
      arg(:id, non_null(:id))
  ...
  object :users_mutations do
    ...
    field :update_profile,
      type: :user_payload,
      description: "Updates current user's profile" do
      arg(:name, :string)
    ...
    field :update_locale,
      type: :user_payload,
      description: "Updates current user's locale" do
